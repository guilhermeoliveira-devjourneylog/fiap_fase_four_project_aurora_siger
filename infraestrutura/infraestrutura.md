A infraestrutura da colônia lunar é organizada como uma rede integrada de módulos especializados, cada um responsável por uma função crítica para a sobrevivência e expansão da base. Todos os módulos operam de forma coordenada por meio de sistemas de comunicação, supervisão e distribuição energética centralizados.

## Topologia

![Topologia da Base](/utils/img/topologia.png)
...
![Topologia da Base](/utils/img/centro_de_controle.png)
...
![Topologia da Base](/utils/img/modulo_agricultura.png)
...
![Topologia da Base](/utils/img/modulo_de_comunicacao.png)
...
![Topologia da Base](/utils/img/modulo_de_energia.png)

É a espinha dorsal operacional da base. A geração energética é realizada por um reator de fusão e um campo solar lunar. O módulo possui armazenamento em baterias de grande capacidade, rede inteligente de distribuição, sistemas de regulação elétrica, monitoramento centralizado e fontes redundantes para contingências.

Capacidade Energética Atual

- Produção total: 22.500 MW

- Energia disponível para distribuição: 18.750 MW

- Consumo do complexo energético: 850 MW
...
![Topologia da Base](/utils/img/modulo_de_pesquisa.png)
...
![Topologia da Base](/utils/img/modulo_de_recursos.png)
...
![Topologia da Base](/utils/img/modulo_de_habitacao.png)
...
![Topologia da Base](/utils/img/modulo_medico.png)
...
![Topologia da Base](/utils/img/modulo_de_transporte.png)
